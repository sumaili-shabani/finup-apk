    ...
    <script type="text/javascript" language="javascript" >  
	 $(document).ready(function(){  
	      ...
	      var dataTable = $('#user_data').DataTable({  
	           ...
	           "order":[],  
	           "ajax":{  
	                url:"<?php echo base_url() . 'Admin/fetch_infos'; ?>",  
	                type:"POST",  
	  ...
	  $(document).on('submit', '#user_form', function(event){  
           ...
           if(infos != '' && typeInfos != '')
            {
	            ...
	            if (action =="Add") {
	                ...
	                $.ajax({  
	                     url:"<?php echo base_url() . 'admin/insert_operation_info'?>",  
	                     method:'POST',  
	            ...
	            if (action == 'Edit') {
                  ...
                  if (extension =='') {
                    ...
                    $.ajax({  
                         url:"<?php echo base_url() . 'admin/update_operation_infos2'?>",  
                         method:'POST',  
                         data:new FormData(this),  
                         contentType:false,  
                         processData:false,  
                    ...
                    $.ajax({  
                         url:"<?php echo base_url() . 'admin/update_operation_infos'?>",  
                         method:'POST',  
                         data:new FormData(this),  
                         contentType:false,  
                         processData:false,  
	      ...
	      $(document).on('click', '.update', function(){  
	           ...
	           $.ajax({  
	                url:"<?php echo base_url(); ?>Admin/fetch_single_infos",  
	                method:"POST",  
	                data:{code:code},  
	                dataType:"json",  
	                success:function(data)  
	      ...
	      $(document).on('click', '.voir_plus', function(){  
	           var code = $(this).attr("code");  
	           $.ajax({  
	                url:"<?php echo base_url(); ?>Admin/fetch_single_infos2",  
	                method:"POST",  
	                data:{code:code},  
	                dataType:"json",  
	                success:function(data)  
	      ...
	      $(document).on('click', '.delete', function(){
	          ...
	          if(confirm("Etes-vous sûre de vouloir le supprimer?"))
	          {
	            	...
	            	$.ajax({
		              url:"<?php echo base_url(); ?>Admin/delete_operation_infos",
		              method:"POST",
		              data:{code:code},
		              success:function(data)
		              {
