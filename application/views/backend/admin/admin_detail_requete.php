                    ...
                    <?php 
                            ...
                            if ($detail->num_rows() > 0) {
                             ...
                             <?php 
                                ...
                                $detail = $this->db->query('SELECT count(TypeOp) AS nombre FROM v_operation  WHERE dateAdd BETWEEN "'.$dateAdd.'" AND "'.$dateAdd2.'" AND codeEntrep= "'.$codeEntrep.'" ');
                                if ($detail->num_rows() > 0) {
                                    foreach ($detail->result_array() as $key) {
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="text-center">
                                                                <p class="img img-center">
                                                                    <a href="<?php echo(base_url()) ?>Admin/admin_entreprise_detail/<?php echo($codeEntrep) ?>">
                                                    ...
                                                    <div class="tab-pane fade active show" id="v-pills-dash" role="tabpanel" aria-labelledby="v-pills-dash-tab">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                 ...
                                                                 <form method="POST" action="<?php echo(base_url()) ?>Admin/requete/show/<?php echo($codeEntrep) ?>" class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <input type="date" name="dateAdd" class="form-control" value="<?php echo($dateAdd) ?>" >
                                                                                        </div>

                                                                                        <div class="col-md-6">
                                                                                            <input type="date" name="dateAdd2" class="form-control" value="<?php echo($dateAdd2) ?>">
                                                                                        </div>
                                                                    ...
                                                                    <?php echo($nombre_total_devise) ?>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="row">
                                                                                ...
                                                                                $nombre;
                                                                                $chart_data = '';
                                                                                $detail = $this->db->query('SELECT count(TypeOp) AS nombre, TypeOp,dateAdd FROM v_operation WHERE dateAdd BETWEEN "'.$dateAdd.'" AND "'.$dateAdd2.'" AND codeEntrep= "'.$codeEntrep.'" GROUP BY TypeOp ');
                                                                                if ($detail->num_rows() > 0) {
                                                                                    foreach ($detail->result_array() as $key) {
                ...
                <div class="table-responsive">
                   ...
                   <tbody>
                       <?php 
                            ...
                            $detail2 = $this->db->query('SELECT * FROM v_operation WHERE dateAdd BETWEEN "'.$dateAdd.'" AND "'.$dateAdd2.'" AND codeEntrep="'.$codeEntrep.'" ');
    ...
    <div class="modal fade" id="userModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo(base_url()) ?>Admin/update_users">
                    <div class="col-md-12">
                        <div class="form-group">
                            <p>
                                <?php
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                         ...
                                         <?php 
                                            ...
                                            $detail4 = $this->db->query('SELECT SUM(Montant) AS somme, devise FROM v_operation WHERE dateAdd BETWEEN "'.$dateAdd.'" AND "'.$dateAdd2.'" AND codeEntrep= "'.$codeEntrep.'"  GROUP BY devise ');
