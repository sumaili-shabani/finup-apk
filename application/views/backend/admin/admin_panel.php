                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <h6 class="text-muted text-uppercase mt-0">Nombre total des entreprises actives</h6>
                                    ...
                                    if ($nbr_entrer>0) {
                                        ?>
                                        <a class="text-info" href="<?php echo(base_url())?>Admin/admin_entreprise"> 
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if ($nbr_users>0) {
                                        ?>
                                        <a class="text-info" href="<?php echo(base_url())?>Admin/admin_select_detail"> 
                                            voir plus <i class="bx bx-plus"></i>
                                        </a>
                                        <?php
                                    }
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if ($nbr_operation>0) {
                                        ?>
                                        <a class="text-info" href="<?php echo(base_url())?>Admin/admin_select_operation/voir_plus"> 
                                            voir plus <i class="bx bx-plus"></i>
                                        </a>
                                        <?php
                                    }
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-xl mb-0 user_data" id="recent-orders">
                                            ...
                                            <?php 
                                            $nbr_entrer_etat_false;
                                            $v_user = $this->db->query("SELECT * FROM v_user GROUP BY nom");
                                            if ($v_user->num_rows() > 0) {
                                                ...
                                                foreach ($v_user->result_array() as $key) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-truncate"><a href="<?php echo(base_url()) ?>Admin/admin_entreprise_detail/<?php echo($key['codeEntrep']) ?>" class="btn btn-warning btn-xs"><i class="fa fa-plus-circle"></i></a></td>
                                                    </tr>
                                                    <?php
