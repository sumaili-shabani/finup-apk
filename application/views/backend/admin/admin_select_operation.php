                    		...
                    		<div class="row">
                    			<div class="col-md-12">
                    				<div class="row">
		                    			...
		                    			<div class="col-md-2">
		                    				<form method="POST" action="<?php echo(base_url()) ?>Admin/admin_select_operation/show">
                    	...
                    	<div class="col-md-12">
                    		...
                    		<div class="row">
                                ...
                                foreach ($detail2->result_array() as $key) {
                                    ...
                                    $chart_data4 .= "{ indexLabel:'".$key["devise"]."', y:".$key["nombre"]."}, ";
    ...
    <script type="text/javascript" language="javascript" >  
     $(document).ready(function(){  
        ...
        var chart3 = new CanvasJS.Chart("chartContainer3", {
            ...
            animationEnabled: true,
            title: {
                text: "statistique des opérations parraport aux types d'opérations"
            },
