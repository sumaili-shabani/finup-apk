...
<body>
	                    		...
	                    		<div class="row">
	                    			<div class="col-md-12">
	                    				<div class="row">
			                    			...
			                    			<div class="col-md-2">
			                    				<form method="POST" action="<?php echo(base_url()) ?>Admin/injection_admin_select_entreprise/show">
 ...
 -->
	                                       ...
	                                       <tbody id="example-tbody">
                                            ...
                                            if ($durree =='') {
                                               $query = $this->db->query("SELECT * FROM v_user WHERE License='".$designation."' AND reste <= '".$durree."' GROUP BY nom ");
                                            }
                                            else{
                                                $query = $this->db->query("SELECT * FROM v_user WHERE License='".$designation."' GROUP BY nom ");
                                            }
