    ...
    <script type="text/javascript" language="javascript" >  
	 $(document).ready(function(){  
	      ...
	      $(document).on('click', '.voir_plus', function(){  
	           ...
	           $.ajax({  
	                url:"<?php echo base_url(); ?>Users/fetch_single_licence",  
	                method:"POST",  
	                data:{code:code},  
	                dataType:"json",  
	      ...
	      $(document).on('click', '.delete', function(){  
	          ...
	          if(confirm("Etes-vous sûre de vouloir faire expirer cette licence?"))
	          {
		            ...
		            $.ajax({  
		                url:"<?php echo base_url(); ?>Users/update_expire_licence_system",  
		                method:"POST",  
		                data:{
		                	code: code
		                },   
	      ...
	      $(document).on('submit', '#user_form', function(event){ 
	           ...
	           if (codeType != '' && codeEntrep !='' && debut1 !='' && fin1 !='') {
		           ...
		           if (action=="Add") {
	           			$.ajax({  
			                url:"<?php echo base_url(); ?>Users/insert_lecence_system",  
			                method:"POST",  
			                data:{
			                	codeType: codeType,
	           		...
	           		if (action == "Edit") {
	           			...
	           			$.ajax({  
			                url:"<?php echo base_url(); ?>Users/update_licence_system",  
			                method:"POST",  
			                data:{
			                	codeType: codeType,
			                	codeEntrep: codeEntrep,
