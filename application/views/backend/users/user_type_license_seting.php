    ...
    <script type="text/javascript" language="javascript" >  
	 $(document).ready(function(){  
	      ...
	      var dataTable = $('#user_data').DataTable({  
	           ...
	           "order":[],  
	           "ajax":{  
	                url:"<?php echo base_url() . 'Users/fetch_type_licence'; ?>",  
	                type:"POST",  
	      ...
	      $(document).on('submit', '#user_form', function(event){ 
	           ...
	           if (designation != '' && montant !='' && durree !='') {
		           ...
		           if (action=="Add") {
	           			$.ajax({  
			                url:"<?php echo base_url(); ?>Users/insert_operation_type_licence",  
			                method:"POST",  
			                data:{
	           		...
	           		if (action == "Edit") {
	           			...
	           			$.ajax({  
			                url:"<?php echo base_url(); ?>Users/update_operation_type_licence",  
			                method:"POST",  
			                data:{
			                	designation: designation,
			                	montant: montant,
	      ...
	      $(document).on('click', '.update', function(){  
	           ...
	           $.ajax({  
	                url:"<?php echo base_url(); ?>Users/fetch_single_type_licence",  
	                method:"POST",  
	                data:{code:code},  
	                dataType:"json",  
	                success:function(data)  
	      ...
	      $(document).on('click', '.delete', function(){
	          ...
	          if(confirm("Are you sure you want to delete this?"))
	          {
	            ...
	            $.ajax({
	              url:"<?php echo base_url(); ?>Users/delete_operation_type_licence",
	              method:"POST",
	              data:{code:code},
	              success:function(data)
	              {
