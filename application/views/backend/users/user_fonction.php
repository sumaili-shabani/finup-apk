	                                   	...
	                                   	if ($menu->num_rows() > 0) {
	                                   		foreach ($menu->result_array() as $key) {
	                                   			...
	                                   			<tr>
	                                   				...
	                                   				<td width="5%"><a href="<?php echo(base_url()) ?>Users/modifier_fonction/view_detail/<?php echo($key['iduser']) ?>" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a></td>
	                                   			</tr>
	                                   			<?php
	                                   		}
	                                   	}
 		  ...
 		  event.preventDefault();
	  	  ...
	  	  if (id !='') {
	  	  	  ...
	  	  	  if(checkbox.length > 0)
			  {
				   ...
				   $.ajax({
					    url:"<?php echo base_url(); ?>Users/Ajoutfonction",
					    method:"POST",
					    data:{
