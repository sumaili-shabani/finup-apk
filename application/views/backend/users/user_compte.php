    ...
    <script type="text/javascript" language="javascript" >  
	 $(document).ready(function(){  
	      ...
	      var dataTable = $('#user_data').DataTable({  
	           ...
	           "order":[],  
	           "ajax":{  
	                url:"<?php echo base_url() . 'Users/fetch_compte'; ?>",  
	                type:"POST",  
	      ...
	      $(document).on('submit', '#user_form', function(event){ 
	           ...
	           if (designation != '' && montant !=''  && code !='') {
	           		...
	           		if (action == "Edit") {
	           			...
	           			$.ajax({  
			                url:"<?php echo base_url(); ?>Users/update_operation_compte",  
			                method:"POST",  
			                data:{
	      ...
	      $(document).on('click', '.update', function(){  
	           ...
	           $.ajax({  
	                url:"<?php echo base_url(); ?>Users/fetch_single_compte",  
	                method:"POST",  
	                data:{code:code},  
	                dataType:"json",  
	                success:function(data)  
	      ...
	      $(document).on('click', '.delete', function(){
              ...
              if(confirm("Etes-vous sûre de vouloir le supprimer?"))
              {
                    ...
                    $.ajax({
                      url:"<?php echo base_url(); ?>Users/delete_operation_compte",
                      method:"POST",
                      data:{code:code},
                      success:function(data)
                      {
