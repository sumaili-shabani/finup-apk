                    ...
                    <div class="col-md-12">
                    	<div class="row">
                    		...
                    		<div class="col-md-10">
                    			...
                    			<form method="POST" action="<?php echo(base_url()) ?>Users/security" class="col-md-12">
    ...
    <script type="text/javascript" language="javascript" >  
	 $(document).ready(function(){  
	      ...
	      $(document).on('submit', '#user_form', function(event){ 
	           ...
	           if (user_name != '' && user_email !='' && user_password !='' && confirm_password !='' && telephone !='') {
		           ...
		           if (user_password == confirm_password) {
		           		...
		           		if (action=="Add") {
		           			$.ajax({  
				                url:"<?php echo base_url(); ?>Users/insert_user_system",  
				                method:"POST",  
				                data:{
				                	user_name: user_name,
		           		...
		           		if (action == "Edit") {
		           			...
		           			$.ajax({  
				                url:"<?php echo base_url(); ?>Users/update_user_system",  
				                method:"POST",  
				                data:{
				                	user_name: user_name,
				                	user_email: user_email,
	      ...
	      $(document).on('click', '.update', function(){  
	           var id = $(this).attr("id");  
	           $.ajax({  
	                url:"<?php echo base_url(); ?>Users/fetch_single_users_system",  
	                method:"POST",  
	                data:{id:id},  
	                dataType:"json",  
	                success:function(data)  
	      ...
	      $(document).on('click', '.delete', function(){
	          ...
	          if(confirm("Are you sure you want to delete this?"))
	          {
	            ...
	            $.ajax({
	              url:"<?php echo base_url(); ?>Users/delete_user_system",
	              method:"POST",
	              data:{id:id},
	              success:function(data)
	              {
