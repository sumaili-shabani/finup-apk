...
class Admin extends CI_Controller {
    ...
    function admin_entreprise($param1 ='', $param2=''){
        if ($param1 =='page') {
            ...
            $this->load->view('backend/admin/admin_entreprise', $data);
        }
        $data['title'] = "profile des nos entreprises";
        $this->load->view('backend/admin/admin_entreprise', $data);
    ...
    function admin_entreprise_detail($param1 ='', $param2 ='', $param3 =''){
        ...
        $this->load->view('backend/admin/admin_detail_entreprise', $data);

    }

    function admin_select_detail(){
        $data['title'] = "détail de l'entreprise";
        $this->load->view('backend/admin/admin_select_users', $data);
    ...
    function admin_select_operation($param1 ='', $param2 ='', $param3 =''){
        ...
        if ($param1 == "show") {
          ...
          $this->load->view('backend/admin/admin_show_detail', $data);
        }
        elseif ($param1=="voir_plus") {
          $this->load->view('backend/admin/admin_select_operation', $data);
        }
        else{
    ...
    function profile_admin(){
        ...
        $this->load->view('backend/admin/admin_profile', $data);
    }
    ...
    function modifier_fonction($param1='', $param2='', $param3=''){
      if ($param1=='view_detail') {
        ...
        $data['id'] = $param2;
        $this->load->view('backend/admin/admin_modifier_fonction', $data);
      }
      else{
    ...
    function seting(){
        ...
        $this->load->view('backend/admin/admin_seting', $data);
    }

    function seting_compte(){
        $data['title'] = "reglage de  paramètrage de compte";
        $this->load->view('backend/admin/admin_compte', $data);
    }

    function seting_devise(){
        $data['title'] = "reglage de  paramètrage de devise";
        $this->load->view('backend/admin/admin_devise', $data);
    }

    function seting_fonction(){
        $data['title'] = "reglage de  paramètrage des fonctions";
        $this->load->view('backend/admin/admin_fonction_seting', $data);
    }
    
    function seting_license(){
        $data['title'] = "reglage de  paramètrage des licenses";
        $this->load->view('backend/admin/admin_license_seting', $data);
    }

    function seting_type_license(){
        $data['title'] = "reglage de  paramètrage des licenses";
        $this->load->view('backend/admin/admin_type_license_seting', $data);
    }

    function seting_type_infos(){
        $data['title'] = "reglage de  paramètrage des informations";
        $this->load->view('backend/admin/admin_infos_seting', $data);
    }

    function injection_seting_type_license(){
        $data['title'] = "reglage de  paramètrage des informations";
        $this->load->view('backend/admin/admin_injection_seting', $data);
    }
    ...
    function injection_admin_select_entreprise($param1 ='', $param2 ='', $param3 =''){
        ...
        if ($param1 == "show") {
          ...
          $this->load->view('backend/admin/admin_select_entreprise_injection', $data);
        }
        elseif ($param1=="voir_plus") {
          $this->load->view('backend/admin/admin_select_operation', $data);
        }
    ...
    function requete($param1='', $param2='', $param3=''){
        ...
        if ($param1 == "show") {
          ...
          $this->load->view('backend/admin/admin_detail_requete', $data);
        }
        elseif ($param1=="voir_plus") {
          $this->load->view('backend/admin/admin_detail_requete', $data);
        }
    ...
    function fetch_users(){  
      ...
      function update_users(){
          ...
          $subject = "Update verify informations";
              ...
              if(mail($to,$subject,$message2,$headers) > 0){
                  ...
                  redirect(base_url().'admin/admin_entreprise_detail/'.$codeEntrep);
              } 
              else {
      ...
      function agent(){
        ...
        $this->load->view('backend/admin/admin_agent', $data);
      }

      function show_select_fonction(){
        $data['title'] = "Ajout opérations des fonctions";
        $this->load->view('backend/admin/admin_fonction', $data);
      }
   ...
   function security_one(){
     ...
     $this->session->set_flashdata('message1_success', 'votre profile a été changer avec succès '.$first_name);
      redirect(base_url().'Admin/profile_admin');
   }
